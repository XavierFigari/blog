...
<?php else : ?>
    <h2><?= $post[0]["title"] ?></h2>
        ...
        <a class="modifPost" href="?action=blogPostModify&id=<?= $postId ?>">Modifier l'article</a>
        <a class="modifPost" href="?action=blogPostDelete&id=<?= $postId ?>">Supprimer l'article (irréversible !)</a>
        <h2>Commentaires :</h2>
